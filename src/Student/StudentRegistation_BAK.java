...
public class StudentRegistation_BAK extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtRegNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 50, 180, 30));

        jLabel29.setFont(new java.awt.Font("Times New Roman", 0, 15)); // NOI18N
        jLabel29.setText("NIC");
        jPanel1.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 50, 120, 30));
        ...
        jPanel1.add(txtSubTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 500, 160, 30));
        ...
        jPanel1.add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 600, 120, 40));
        ...
        jPanel1.add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(1120, 600, 120, 40));

        jLabel5.setFont(new java.awt.Font("Times New Roman", 0, 15)); // NOI18N
        jLabel5.setText("Lsat Entered no");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 20, 120, 20));
        ...
        jPanel1.add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 510, 70, 20));
        ...
        jPanel1.add(jLabel33, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 280, 70, 20));
        ...
        tableStudent.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Vehicle Category", "Type", "Amount", "Discount", "Total"
            }
        ) {
        ...
        jPanel3.add(txtPassportNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, 180, 30));
        ...
        jPanel3.add(txtLPNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 180, 30));

        jLabel26.setFont(new java.awt.Font("Times New Roman", 0, 15)); // NOI18N
        jLabel26.setText("Old DL");
        jPanel3.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 10, 50, 30));
        ...
        jPanel3.add(setDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 60, 180, 30));
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 60, 120, 20));
        ...
        jPanel1.add(maxstno, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 20, 120, 20));
        ...
        jPanel1.add(maxreg1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 20, 90, 20));
                ...
                try {
                    ...
                    if (btnSave.getText().equals("SAVE")) {
                        String insert_1 = "INSERT INTO students (RegNo,NIC,PassportNo,OldDLNo,FullName,LPNumber,DOB,Gender,AddressPermenent,AddressResident,CourseFee,TpHome,TpBusiness,TpPersonal,Image,RegisterDate,StudentPosition)"
                                + " VALUES ('" + txtRegNo.getText() + "','" + txtNic.getText() + "','" + txtPassportNo.getText() + "','" + txtOldDL.getText() + "','" + txtName.getText() + "','" + txtLPNo.getText() + "','" + getDob + "','" + gen + "','" + txtPerAddress.getText() + "','" + txtResAddress.getText() + "','" + txtSubTotal.getText() + "','" + txtTPHome.getText() + "','" + txtTPBusiness.getText() + "','" + txtTPMobile.getText() + "','" + path + "','" + setDate.getText() + "','" + txtPosition.getText() + "') ";
                        ...
                        for (int i = 0; i < dtm.getRowCount(); i++) {
                            ...
                            ResultSet rs2 = DB.search("SELECT * FROM students WHERE RegNo='" + txtRegNo.getText() + "' ");
                            if (rs2.next()) {
                        ...
                        if (x == 0) {
                            ...
                            String update_1 = "UPDATE students SET RegNo='" + txtRegNo.getText() + "',NIC='" + txtNic.getText() + "',PassportNo='" + txtPassportNo.getText() + "',OldDLNo='" + txtOldDL.getText() + "',LPNumber='" + txtLPNo.getText() + "',"
                                    ...
                                    + "TpHome='" + txtTPHome.getText() + "',TpBusiness='" + txtTPBusiness.getText() + "',TpPersonal='" + txtTPMobile.getText() + "',Image='" + path + "',RegisterDate='" + setDate.getText() + "',StudentPosition='" + txtPosition.getText() + "' WHERE idstudents='" + lableStudentID.getText() + "' ";
                            DB.idu(update_1);
...
//            double getNetTotal=(getTotal*getAmount)/100;
            ...
            tableStudent.setValueAt(getNetTotal, tableStudent.getSelectedRow(), 4);
...
//        checkFemale.grabFocus();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentRegistation_BAK().setVisible(true);
            }
        });
    }
...
private void maximizeWindow() {
        if (maximized) {
            ...
            StudentRegistation_BAK.this.setExtendedState(JFrame.MAXIMIZED_BOTH);
            GraphicsEnvironment gv = GraphicsEnvironment.getLocalGraphicsEnvironment();
            StudentRegistation_BAK.this.setMaximizedBounds(gv.getMaximumWindowBounds());
            maximized = true;
        } else {
