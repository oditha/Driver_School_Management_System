...
public class ViewTrialPayments extends javax.swing.JFrame {
static boolean maximized = true;
    public ViewTrialPayments() {
        initComponents();
        maximizeWindow();
    }
    ...
    private void initComponents() {
        ...
        setTitle("View Trial Payments-New Kamal Learners | Rikillagaskada");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder("View Exam Dates"), "View Trial Payments", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N
    ...
    private void txtFilterKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtFilterKeyReleased
        ...
        try {
            ...
            if (txtFilter.getText().isEmpty()) {
                ...
                rs=DB.search("SELECT students.*, trial.*, trialpayment.* FROM trial INNER JOIN trialpayment ON trialpayment.Trial_idTrial = trial.idTrial INNER JOIN students ON trial.idstudents = students.idstudents WHERE students.RegNo LIKE '"+txtFilter.getText()+"%'");

            }else if (checkNic.isSelected()) {

                rs=DB.search("SELECT students.*, trial.*, trialpayment.* FROM trial INNER JOIN trialpayment ON trialpayment.Trial_idTrial = trial.idTrial INNER JOIN students ON trial.idstudents = students.idstudents WHERE students.NIC LIKE '"+txtFilter.getText()+"%'");

            }else {
                System.out.println("ss");
               rs=DB.search("SELECT students.*, trial.*, trialpayment.* FROM trial INNER JOIN trialpayment ON trialpayment.Trial_idTrial = trial.idTrial INNER JOIN students ON trial.idstudents = students.idstudents WHERE students.FullName LIKE '"+txtFilter.getText()+"%'");
            }
            ...
            while (rs.next()) {
                ...
                v.add(rs.getString("DatePayment"));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewTrialPayments().setVisible(true);
            }
        });
    }
...
private void maximizeWindow() {
        if (maximized) {
            ...
            ViewTrialPayments.this.setExtendedState(JFrame.MAXIMIZED_BOTH);
            GraphicsEnvironment gv = GraphicsEnvironment.getLocalGraphicsEnvironment();
            ViewTrialPayments.this.setMaximizedBounds(gv.getMaximumWindowBounds());
            maximized = true;
        } else {
