...
public class ViewTrialAttendnce extends javax.swing.JFrame {
static boolean maximized = true;
    public ViewTrialAttendnce() {
        initComponents();
        maximizeWindow();
    }
    ...
    private void initComponents() {
        ...
        setTitle("View Trial Attendence-New Kamal Learners | Rikillagaskada");
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, 1240, 470));
        ...
        jPanel4.add(btnFilter, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 50, 120, 40));
...
txtFilter.setText(null);
                ...
                if (webDate.getText().isEmpty() ) {
                 ...
                 ResultSet rs = DB.search("SELECT students.*, trialdayattendece.* FROM trialdayattendece INNER JOIN students ON trialdayattendece.idstudents = students.idstudents WHERE trialdayattendece.TrialDate = '"+webDate.getText()+"' ");
    ...
    private void txtFilterKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtFilterKeyReleased
        ...
        try {
            ...
            if (txtFilter.getText().isEmpty()) {
                ...
                rs=DB.search("SELECT students.*, trialdayattendece.* FROM trialdayattendece INNER JOIN students ON trialdayattendece.idstudents = students.idstudents WHERE students.RegNo LIKE '"+txtFilter.getText()+"%'");

            }else if (checkNic.isSelected()) {

                rs=DB.search("SELECT students.*, trialdayattendece.* FROM trialdayattendece INNER JOIN students ON trialdayattendece.idstudents = students.idstudents WHERE students.NIC LIKE '"+txtFilter.getText()+"%'");

            }else {
                System.out.println("ss");
                rs=DB.search("SELECT students.*, trialdayattendece.* FROM trialdayattendece INNER JOIN students ON trialdayattendece.idstudents = students.idstudents WHERE students.FullName LIKE '"+txtFilter.getText()+"%'");
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewTrialAttendnce().setVisible(true);
            }
        });
    }
...
private void maximizeWindow() {
        if (maximized) {
            ...
            ViewTrialAttendnce.this.setExtendedState(JFrame.MAXIMIZED_BOTH);
            GraphicsEnvironment gv = GraphicsEnvironment.getLocalGraphicsEnvironment();
            ViewTrialAttendnce.this.setMaximizedBounds(gv.getMaximumWindowBounds());
            maximized = true;
        } else {
