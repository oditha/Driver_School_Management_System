...
public class ViewServiceDetails extends javax.swing.JFrame {
static boolean maximized = true;
    public ViewServiceDetails() {
        initComponents();
        maximizeWindow();
        setTable();
        //setCostParts();
    ...
    private void initComponents() {
        ...
        tableViewService = new javax.swing.JTable();
        ...
        tableServiceparts = new javax.swing.JTable();
        ...
        setTitle("View Service Details-New Kamal Learners | Rikillagaskada");
        ...
        tableViewService.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Service Name", "Bill No", "Vehicle", "Cost per Parts", "Worker Cost", "Date"
            }
        ));
        jScrollPane1.setViewportView(tableViewService);
        ...
        jPanel1.add(txtCostParts, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 550, 310, 30));
        ...
        jPanel1.add(txtWorkerCost, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 590, 310, 30));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel3.setText("Total Cost");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 640, 130, 20));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel4.setText("Total Cost Per Parts");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 560, 130, 20));
        ...
        jPanel2.add(webDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 280, 30));
        ...
        jPanel2.add(btnDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 90, 130, 40));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 40, 330, 140));

        tableServiceparts.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane2.setViewportView(tableServiceparts);
        ...
        jPanel1.add(txtTotalCost, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 630, 310, 30));

        jLabel6.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel6.setText("Total Worker Cost");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 600, 130, 20));
        ...
        jPanel3.add(radioVehicle, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, -1, -1));
        ...
        jPanel3.add(radioGarage, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 10, -1, -1));
        ...
        jPanel3.add(comboFilter, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 310, 30));
        ...
        jPanel3.add(btnFilter, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 90, 120, 40));
    ...
    private void radioGarageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioGarageActionPerformed
        try {
            ...
            ResultSet rs=DB.search("SELECT DISTINCT ServiceName FROM vehicleservice");
            comboFilter.addItem("Select All");
            while (rs.next()) { 
                String s=rs.getString("ServiceName");
    ...
    private void btnFilterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFilterActionPerformed
           try {
               if (comboFilter.getSelectedIndex()==0) {
                   setTable();
                   DefaultTableModel dtm2=(DefaultTableModel) tableServiceparts.getModel();
                   dtm2.setRowCount(0);
                   setCostParts();
                   setWorkerCost();
                   setTotal(); 
                ...
                if (radioVehicle.isSelected()) {
                  ...
                  ResultSet rs=DB.search("SELECT v.*,vs.* FROM vehicle v INNER JOIN vehicleservice vs ON v.idVehicle=vs.idVehicle WHERE VehicleNumber='"+s[0]+"' ORDER BY Date DESC");
                  DefaultTableModel dtm=(DefaultTableModel) tableViewService.getModel();
                  dtm.setRowCount(0);
                  while (rs.next()) {                
                  Vector v=new Vector();
                  ...
                  v.add(rs.getString("workerFee"));
                  v.add(rs.getString("Date"));
                  dtm.addRow(v);
               }
                  ResultSet rs2=DB.search("SELECT v.*,vs.*, sp.* FROM vehicleservice vs INNER JOIN servicespirepart sp ON vs.idVehicleService=sp.idVehicleService INNER JOIN vehicle v ON v.idVehicle=vs.idVehicle WHERE VehicleNumber='"+s[0]+"' ");
                  DefaultTableModel dtm2=(DefaultTableModel) tableServiceparts.getModel();
                  dtm2.setRowCount(0);
                      while (rs2.next()) {                
                      Vector v=new Vector();
                   ...
                   String selectService=(String) comboFilter.getSelectedItem();
                   ResultSet rs=DB.search("SELECT v.*,vs.* FROM vehicle v INNER JOIN vehicleservice vs ON v.idVehicle=vs.idVehicle WHERE ServiceName='"+selectService+"' ORDER BY Date DESC");
                   DefaultTableModel dtm=(DefaultTableModel) tableViewService.getModel();
                   dtm.setRowCount(0);
                   while (rs.next()) {                
                   Vector v=new Vector();
                   ...
                   ResultSet rs2=DB.search("SELECT v.*,vs.*, sp.* FROM vehicleservice vs INNER JOIN servicespirepart sp ON vs.idVehicleService=sp.idVehicleService INNER JOIN vehicle v ON v.idVehicle=vs.idVehicle WHERE ServiceName='"+selectService+"' ");
                   DefaultTableModel dtm2=(DefaultTableModel) tableServiceparts.getModel();
                   dtm2.setRowCount(0);
                      while (rs2.next()) {                
                      Vector v=new Vector();
    ...
    private void btnDateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDateActionPerformed
              try {
                  if (webDate.getDate()==null) {
                   ...
                   ResultSet rs=DB.search("SELECT v.*,vs.* FROM vehicle v INNER JOIN vehicleservice vs ON v.idVehicle=vs.idVehicle WHERE Date='"+getDate+"' ");
                   DefaultTableModel dtm=(DefaultTableModel) tableViewService.getModel();
                   dtm.setRowCount(0);
                   while (rs.next()) {                
                   Vector v=new Vector();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewServiceDetails().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tableServiceparts;
    private javax.swing.JTable tableViewService;
...
private void maximizeWindow() {
        if (maximized) {
            ...
            ViewServiceDetails.this.setExtendedState(JFrame.MAXIMIZED_BOTH);
            GraphicsEnvironment gv = GraphicsEnvironment.getLocalGraphicsEnvironment();
            ViewServiceDetails.this.setMaximizedBounds(gv.getMaximumWindowBounds());
            maximized = true;
        } else {
    ...
    private void setTable() {
        try {
            ResultSet rs=DB.search("SELECT v.*,vs.* FROM vehicle v INNER JOIN vehicleservice vs ON v.idVehicle=vs.idVehicle ORDER BY Date DESC");
            DefaultTableModel dtm=(DefaultTableModel) tableViewService.getModel();
            dtm.setRowCount(0);
            while (rs.next()) {                
                Vector v=new Vector();
    ...
    private void setCostParts() {
                Double sum=0.00;
                for (int i = 0; i < tableViewService.getRowCount(); i++) {
                    double getsum=Double.parseDouble((String) tableViewService.getValueAt(i, 3));
                    sum=getsum+sum;
    ...
    private void setWorkerCost() {
                Double sum=0.00;
                for (int i = 0; i < tableViewService.getRowCount(); i++) {
                    double getsum=Double.parseDouble((String) tableViewService.getValueAt(i, 4));
                    sum=getsum+sum;
